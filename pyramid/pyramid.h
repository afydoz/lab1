...
#define NF3 8                        /* 3 top inner face number */
#define NF4 17                /* Any top inner face number */
#define NFACE (NF3+NF4)                  /* all inner face number (=4) */
/* #define NFACE (NF3+NF4+ ... ) */ 
#define NEDGE ((3*NF3+4*NF4+MB0)/2)        /* edge number (=8) */
